<%-- 
    Document   : bsc.jsp
    Created on : 09-Apr-2023, 11:53:19 am
    Author     : Ravindra
--%>
    ...
    <body>
        ...
        <div class="container-fluid ">
            <div class="jumbotron bg-info">
                ...
                <p>Prepare for a career in the rapidly-growing field of computer science with our B.Sc program. Our curriculum emphasizes both theory and practical skills to give you a well-rounded education that will make you a valuable asset to any company.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2>Why Choose our B.Sc Computer Science program?</h2>
                    <p>Our program provides students with:</p>
                    <ul>
                        <li>A strong foundation in computer science theory and programming</li>
                        <li>Hands-on experience with state-of-the-art technology</li>
                ...
                <div class="col-md-6">
                    ...
                    <p>Graduates of our B.Sc program can pursue careers in:</p>
                    <ul>
